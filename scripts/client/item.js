    ...
    if(renderItemActionDelay) {
        if(itemActionDelayEnabled) {
            ...
            if(sdl.ticks >= finishTime) {
                ...
                drawing.drawRectangle(null, [itemActionDelayPosition.x-(itemActionDelaySize.x/2)-1, itemActionDelayPosition.y-(itemActionDelaySize.y/2)-1], [itemActionDelaySize.x+2, itemActionDelaySize.y+2], backgroundColour, backgroundColour, backgroundColour, backgroundColour);
